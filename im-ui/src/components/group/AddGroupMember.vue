		...
		<div class="agm-container">
			<div class="agm-l-box">
				...
				<el-scrollbar style="height:400px;">
					<div v-for="(friend,index) in friends" :key="friend.friendId">
			...
			handleOk() {
				...
				this.friends.forEach((f) => {
					if (f.isCheck && !f.disabled) {
						inviteVO.ids.push(f.friendId);
					}
				})
				if (inviteVO.ids.length > 0) {
					this.$http({
						url: "/group/invite",
						method: 'post',
						data: inviteVO
