		...
		<el-scrollbar class="group-side-scrollbar">
			<div class="group-side-member-list">
				...
				<div v-for="(member) in groupMembers" :key="member.id">
					<group-member class="group-side-member" v-show="!member.quit && member.memberNickname.startsWith(searchText)" :member="member"
			...
			<el-form labelPosition="top" class="group-side-form" :model="group">
				<el-form-item label="群聊名称">
					<el-input v-model="group.name" :disabled="!isOwner" maxlength="20"></el-input>
				</el-form-item>
				<el-form-item label="群主">
					<el-input :value="ownerName" :disabled="!isOwner"></el-input>
				</el-form-item>
				<el-form-item label="群公告">
					<el-input v-model="group.notice" :disabled="!isOwner" type="textarea" maxlength="1024" placeholder="群主未设置"></el-input>
				</el-form-item>
				<el-form-item label="备注">
					<el-input v-model="group.remark" :disabled="!editing" placeholder="群聊的备注仅自己可见" maxlength="20"></el-input>
				</el-form-item>
				<el-form-item label="我在本群的昵称">
					<el-input v-model="group.memberNickname" :disabled="!editing" placeholder="xx" maxlength="20"></el-input>
				</el-form-item>
...
<script>
	...
	export default {
		...
		computed: {
			ownerName() {
				let member = this.groupMembers.find((m) => m.memberId == this.group.ownerId);
