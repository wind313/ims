		...
		methods: {
			...
			call() {
				this.peerConnection.createOffer((offer) => {
						...
						this.$http({
							url: `/webrtc/private/call?uid=${this.friend.friendId}`,
							method: 'post',
			...
			accept(offer) {
				...
				this.peerConnection.createAnswer((answer) => {
						...
						console.log(this.friend);
						this.$http({
							url: `/webrtc/private/accept?uid=${this.friend.friendId}`,
							method: 'post',
			...
			handup() {
				this.$http({
					url: `/webrtc/private/handup?uid=${this.friend.friendId}`,
					method: 'post'
				})
				this.close();
			...
			cancel() {
				this.$http({
					url: `/webrtc/private/cancel?uid=${this.friend.friendId}`,
					method: 'post'
				})
				this.close();
			...
			sendFailed(reason) {
				this.$http({
					url: `/webrtc/private/failed?uid=${this.friend.friendId}&reason=${reason}`,
					method: 'post'
				})
			},
			sendCandidate(candidate) {
				this.$http({
					url: `/webrtc/private/candidate?uid=${this.friend.friendId}`,
					method: 'post',
